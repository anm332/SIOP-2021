...
#############
# IF YOU GET ERRORS RUNNING THE NEXT FEW LINES,
...
ANOVA (do four profiles of group differ?)
(four profiles based on viol/non-viol, relig/non-relig)
```{r}
...
# 4 profiles 
ggplot(study1, aes(relig_viol, WC))+
  geom_bar(stat="identity")

# relig vs non-relig orgs
ggplot(study1, aes(relig, WC))+
  geom_bar(stat="identity")

# viol vs non-viol orgs
ggplot(study1, aes(viol, WC))+
  geom_bar(stat="identity")
